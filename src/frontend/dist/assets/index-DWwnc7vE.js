...
function LandingPage({ onClaim }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-poppins", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 bg-white border-b border-gray-100 px-4 py-3 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          "aria-label": "Menu",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-5 h-5 text-gray-700" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "px-4 pb-16 pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: "🔥 Limited Stock — Only Today!"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-center text-gray-900 mb-5", children: "Our Latest Products" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "0 8px 32px 0 rgba(0,0,0,0.10), 0 1px 4px 0 rgba(216,199,163,0.3)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-50 flex items-center justify-center pt-6 pb-2 px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold px-2.5 py-0.5 rounded-full bg-red-50 text-red-600", children: "🔴 3 left" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold text-gray-900 leading-tight mb-1", children: "iPhone 17 Pro Max" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mb-4", children: "512GB · Cosmic Orange · Unlocked · Dual eSIM" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-extrabold text-gray-900", children: "$0.00" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm line-through text-gray-400", children: "$1,299" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onClick: handleClaim,
                  className: `w-full flex items-center justify-center gap-2 py-4 rounded-full text-base font-bold tracking-wide transition-all duration-150 ${pressing ? "scale-95" : "scale-100 hover:scale-[1.02]"}`,
                  style: {
                    backgroundColor: "#7ED957",
                    color: "#1a4a0a",
                    boxShadow: pressing ? "none" : "0 4px 16px rgba(126,217,87,0.5)"
                  },
                  children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "🔒 Secure" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "📦 Free Delivery" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "⚡ Instant" })
              ] })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 rounded-2xl bg-gray-50 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold text-gray-700 mb-2", children: "How it works" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-2", children: HOW_STEPS.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: { backgroundColor: "#7ED957", color: "#1a4a0a" },
                  children: HOW_STEPS.indexOf(step) + 1
                }
              ),
              step
            ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-4 left-4 z-50 flex flex-col gap-2 max-w-[240px]", children: toasts.map((toast) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "px-4 py-6 text-center text-xs text-gray-400 border-t border-gray-100", children: [
      "© ",
...
function VerificationPage({ onBack }) {
  const [wavesLoading, setWavesLoading] = reactExports.useState(false);
  const [storyLoading, setStoryLoading] = reactExports.useState(false);
  const handleInstall = reactExports.useCallback((setLoading) => {
    vibrate();
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-poppins animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-extrabold text-white tracking-tight mb-4", children: "iPhone 17 PRO" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base font-bold text-gray-800 leading-snug", children: [
            "Final step: Install & open the app once and get your",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#7ED957" }, children: "iPhone 17 PRO MAX" }),
            " then enter your delivery address 🎁👇"
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-gray-400 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Verification Progress" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "65%" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: wavesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full border-2 border-white border-t-transparent animate-spin-icon" }),
            "Opening…"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: "w-full flex items-center justify-center gap-3 py-4 rounded-xl text-base font-bold text-white transition-all duration-150 active:scale-95 disabled:opacity-70",
          style: { backgroundColor: "#0b1f3a" },
          children: storyLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full border-2 border-white border-t-transparent animate-spin-icon" }),
            "Opening…"
          ] }) : "स्टोरी टीवी इंस्टॉल करें और खोलें"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-gray-400 font-medium", children: "⏳ Waiting for verification..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-gray-400", children: "⚡ Takes less than 30 seconds! Complete one offer ⬆️" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "px-4 py-6 text-center text-xs text-gray-400 border-t border-gray-100 mt-4", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      ". Built with ❤️ using",
      " ",
...
function App() {
  const [screen, setScreen] = reactExports.useState("landing");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto", style: { maxWidth: "430px" }, children: screen === "landing" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LandingPage, { onClaim: () => setScreen("verification") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(VerificationPage, { onBack: () => setScreen("landing") }) });
}
